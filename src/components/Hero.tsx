  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="hero-3d absolute inset-0 z-0">
        <div
          ref={unicornRef}
          data-us-project="Y9WzZyvdB10od1Uy3LUc"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[450px] z-[2] bg-gradient-to-t from-background via-background/50 via-40% to-transparent"></div>
