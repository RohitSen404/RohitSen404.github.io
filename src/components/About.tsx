...
const About = () => {
  ...
  const skills = [
    ...
    { icon: Layout, name: "Tailwind CSS", color: "text-secondary" },
    { icon: Sparkles, name: "GSAP Animations", color: "text-accent" },
    { icon: Database, name: "Python & AI", color: "text-primary" }
  ];
          ...
          <div className="about-content space-y-6">
            ...
            <div className="skills-grid grid grid-cols-2 gap-4 pt-6">
              {skills.map((skill, index) => (
                <div 
                  key={index}
                  className="skill-icon glass-card p-4 rounded-lg hover:glow-border-cyan transition-all duration-300 group cursor-pointer"
                >
